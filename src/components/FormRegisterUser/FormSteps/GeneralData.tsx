...
import { IGeneralData } from "@/interfaces/RegisterUserInterfaces";
...
const GeneralData = ({ changeData, initialData }: GeneralDataProps) => {
  ...
  const handleChange = (field: string, value: any) => {
    ...
    if (field === "mobilePhone" || field === "taxNumber") {
  ...
  return (
    <div className="flex flex-col w-full gap-5 h-full">
      <div className="flex flex-col md:flex-row gap-5">
        ...
        <div className="relative w-full basis-1/3">
          <FloatLabelInput
            ...
            type="text"
            className={`transition-all px-4 py-4 bg-white ${
              errors.taxNumber && "border-2 border-red-500"
            }`}
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <label htmlFor="idIsLeader">É Gestor?</label>
      </div>
    </div>
  );
};
